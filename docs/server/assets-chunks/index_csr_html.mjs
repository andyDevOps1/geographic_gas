...
<head><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
  <meta charset="utf-8">
  <title>Geographic Gas</title>
  <base href="/geographic_gas">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/x-icon" href="iconGas.ico">
...
<style>html,body{height:100%;margin:0}body{display:flex;flex-direction:column}header{background:linear-gradient(90deg,#0e0d0d,#e92525);display:flex;justify-content:center;align-items:center;font-family:Poppins,sans-serif;font-size:36px;font-weight:700;color:#fff;padding:40px 20px;text-align:center}.header-content{display:flex;align-items:center;gap:80px}footer{background-color:#000;padding:10px;text-align:center;font-family:Arial,sans-serif;color:#b8b8b8;justify-content:center;align-items:center;font-weight:700}.footer .p3{color:#bb1212}</style><link rel="stylesheet" href="styles-DE7W5AHY.css" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles-DE7W5AHY.css"></noscript></head>
<header> 
    <div class="header-content" id="header-content">
      <h1>GEOGRAPHIC GAS</h1> 
      <img src="iconGas.png" alt="Logo de Geographic Gas" width="150">
    </div>

</header>
<body ngcm="">
  <app-root></app-root>
<script src="main-Y7JW7FAA.js" type="module"></script></body>
<footer class="footer">
  <div class="p1" id="footer-content">  
    <p>© 2026 Geographic Gas. Todos los derechos reservados.</p>
  </div>
  <div class="p2" id="footer-content">  
    <p>Fuente de los datos:</p>
  </div>
  <div class="p3" id="footer-content">  
    <p>Ministerio de Transición Ecológica</p>
  </div>
</footer>
</html>`;